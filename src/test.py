...
TWEETS_DATA_PATH = 'src/datasets/tweets'
CHAIN_DATA_PATH = 'src/datasets/network/network_data'
COIN_PRICE_PATH = 'src/datasets/network/prices'
...
'''
#blockchain labels for this script
...
#type of data name mapping
chain_prices_cat = {'Coin Price' : "", 'txFee': "avg", 'gasPrice' : "gas", "txCount": "transac"}


#name map to available columns each data set have, as each dataset have different type of columns
